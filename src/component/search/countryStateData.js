export const countryStateData = {
   ...
   ' New Zealand': ["Wellington", "Auckland", "Christchurch", "Hamilton"],
    ...
    'Nigeria': [
      "Abuja", "Lagos", "Kano", "Port Harcourt", "Ibadan", "Benin City", 
      "Maiduguri", "Zaria", "Jos", "Aba", "Ilorin", "Kaduna", "Enugu", 
      "Warri", "Onitsha", "Calabar", "Uyo", "Yola", "Abeokuta", "Owerri", 
      "Sokoto", "Bauchi", "Osogbo", "Akure", "Minna", "Katsina", "Gombe", 
      "Makurdi", "Ekiti", "Asaba", "Awka", "Jalingo", "Lokoja", 
      "Birnin Kebbi", "Damaturu", "Gusau", "Yenagoa", "Umuahia"
  ],
 ...
 '   Papua New Guinea': ["Port Moresby", "Lae", "Mount Hagen", "Madang"],
  ...
  'United Kingdom': [
    ...
    "Southampton", "Portsmouth", "Sunderland", "Coventry", "Wolverhampton", 
    "Derby", "Plymouth", "Stoke-on-Trent", "Bradford", "Kingston upon Hull", 
    "Cambridge", "Oxford", "Bath", "Canterbury", "Chester", "Exeter", 
    "Lancaster", "York", "Winchester", "Salisbury", "Ely", "Truro", 
    "Worcester", "Hereford", "Lichfield", "Ripon", "Wells", "Gloucester", 
    "Edinburgh", "Aberdeen", "Dundee", "Inverness", "Stirling", "Perth", 
    "Cardiff", "Swansea", "Newport", "Wrexham", "St. Asaph", "Bangor", 
